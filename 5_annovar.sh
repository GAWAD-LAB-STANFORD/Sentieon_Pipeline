...
echo "${SLURM_ARRAY_TASK_ID} is the task id"
echo "${SAMPLE_STRING} is the sample string"
echo "${SAMPLE} is the sample"
echo "${RESULTS_DIR} is the results_dir"
