...
#currently the ver being used by 2_scan2.sh
...
echo "RESULTSDIR is ${RESULTS_DIR}"
...
ml purge
ml R/4.0.2 java/1.8.0_131 perl/5.26.0 biology gatk/4.1.4.1 bedtools/2.30.0 samtools/1.8 vcftools/0.1.15
