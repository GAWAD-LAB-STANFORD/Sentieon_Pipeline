...
Rscript ${SCRIPT_DIR}/SigProfiler_2_Trinucleotide_Reformat.R ${PROJECT}.temp_bedtools_reformat.tsv \
    ...
    ${PROJECT}.sigprofiler_input.tsv ${SCRIPT_DIR}/Mutation_Types.tsv
...
#find $SCRATCH/$PROJECT/${PROJECT}_SigProfiler_Results -name '*pdf' -exec mv -t $SCRATCH/$PROJECT/${PROJECT}_SigProfiler_Results {} +

# ml system ghostscript
# gs -dNOPAUSE -sDEVICE=pdfwrite -sOUTPUTFILE=01_${PROJECT}_Sigprofiler.pdf -dBATCH $SCRATCH/$PROJECT/${PROJECT}_SigProfiler_Results/*pdf
# mv 01_${PROJECT}_Sigprofiler.pdf $SCRATCH/$PROJECT
...
#mv ${RESULTS_DIRECTORY}/${PROJECT}_SBS96_Decomposition_Plots.pdf ${RESULTS_DIRECTORY}
#mv  ${RESULTS_DIRECTORY}/${PROJECT}_SBS96_Decomposition_Plots.pdf ${RESULTS_DIRECTORY}/01_${PROJECT}_SBS96_Decomposition_Plots.pdf
